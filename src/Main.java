...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        } catch(MyArraySizeException e){ // поймай ошибку
    ...
    public static int list (String[][] array) throws MyArraySizeException, MyArrayDataException {
        ...
        if(array.length != 2 || array[0].length != 4 || array[1].length != 4) {
            throw new MyArraySizeException(); // создать ошибку
        }
